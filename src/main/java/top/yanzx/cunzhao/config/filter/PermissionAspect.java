package top.yanzx.cunzhao.config.filter;

import top.yanzx.cunzhao.config.annotation.Logical;
import top.yanzx.cunzhao.config.annotation.RequiresPermissions;
import top.yanzx.cunzhao.config.exception.UnauthorizedException;
...
public class PermissionAspect {
    ...
    @Before("@annotation(top.yanzx.cunzhao.config.annotation.RequiresPermissions)")
